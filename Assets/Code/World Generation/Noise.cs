...
//             return values;
//         }
//         public static Color[] BWCalc2D(int width, int height, float scale)
//         {
//             var values = new Color[width*height];
//             for (var i = 0; i < width*height; i++)
//             {
//                 var val = Generate((i/width) * scale, (i%width) * scale) * 128 + 128;
//                 values[i] = new Color(val,val,val,1);
//             }
//             return values;
//         }
...
namespace Noise
{
    ...
    public static float Noise(float x, float y)
    {
        ...
        foreach (var n in corners)
        {
            ...
            total += Drop(uv.x)*Drop(uv.y) * Vector2.Dot(grad, uv);
        }
